...
import { ICategoryData } from "@/lib/store/institute/category/categoryTypes";
import {
  deleteCategory,
  fetchCategories,
...
function InstituteCategories() {
  ...
  const filteredData = categories.filter(
    (category) =>
      category.categoryName.includes(searchedText) ||
      category.id.includes(searchedText) ||
      category.categoryDescription.includes(searchedText)
  );
  return (
